function createNewCard() {
  ...
  function shuffleCardImageClasses() {
    ...
    let cardClasses = ["image-1", "image-2", "image-3", "image-4", "image-5", "image-6", "image-1", "image-2", "image-3", "image-4", "image-5", "image-6",]
  ...
  function createCards(parentElement, shuffledImageClasses) {
    ...
    for (i = 0; i < 12; i++) {
      let cardCreate = appendNewCard(parentElement);
      cardCreate.classList.add(shuffledImageClasses[i]);
      let cards = {
        index: i,
        element: cardCreate,
        imageClass: shuffledImageClasses[i]
      }
      cardObjects.push(cards);
    }
